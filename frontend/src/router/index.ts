...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/wanteds', name: 'wanted-hall', component: () => import('../pages/WantedHallPage.vue') },
    { path: '/wanteds/create', name: 'wanted-create', component: () => import('../pages/WantedCreatePage.vue'), meta: { requiresAuth: true } },
    { path: '/wanteds/:id', name: 'wanted-detail', component: () => import('../pages/WantedDetailPage.vue') },
